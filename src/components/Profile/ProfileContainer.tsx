...
import {getProfile, getStatus, ProfileType, setUserPage, updateStatus} from '../../redux/profileReducer'
...
export default compose(
    ...
    (mapStateToProps, {setUserPage, getProfile, getStatus, updateStatus}),
    withRouter,
    withAuthRedirect)
